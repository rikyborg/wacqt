...
load_folder = "results/single"

# load_filename = "simulate_20200209_020656_0.1_32768.npz"
# load_filename = "simulate_20200209_021414_0.2_32768.npz"
# load_filename = "simulate_20200209_020403_0.5_32768.npz"
# load_filename = "simulate_20200209_021604_1_32768.npz"
# load_filename = "simulate_20200209_022210_2_32768.npz"
# load_filename = "simulate_20200209_023237_5_32768.npz"
# load_filename = "simulate_20200209_022219_10_32768.npz"
# load_filename = "simulate_20200209_021640_20_32768.npz"
# load_filename = "simulate_20200209_021127_50_32768.npz"
load_filename = "simulate_20200209_021401_100_32768.npz"


# load_folder = "results/double"

# # load_filename = "simulate_20200208_211652_0.1_32768.npz"
# # load_filename = "simulate_20200208_211253_0.2_32768.npz"
# # load_filename = "simulate_20200208_211526_0.5_32768.npz"
# # load_filename = "simulate_20200208_211556_1_32768.npz"
# # load_filename = "simulate_20200208_213741_2_32768.npz"
# # load_filename = "simulate_20200208_214352_5_32768.npz"
# # load_filename = "simulate_20200208_213426_10_32768.npz"
# # load_filename = "simulate_20200208_213942_20_32768.npz"
# # load_filename = "simulate_20200208_214217_50_32768.npz"
# load_filename = "simulate_20200208_214202_100_32768.npz"


# load_folder = "results/cool"

# # load_filename = "simulate_20200209_220009_0.1_32768.npz"
# # load_filename = "simulate_20200209_215907_0.2_32768.npz"
# # load_filename = "simulate_20200209_220343_0.5_32768.npz"
# # load_filename = "simulate_20200209_215856_1_32768.npz"
# # load_filename = "simulate_20200209_221531_2_32768.npz"
# # load_filename = "simulate_20200209_221338_5_32768.npz"
# # load_filename = "simulate_20200209_220614_10_32768.npz"
# # load_filename = "simulate_20200209_221502_20_32768.npz"
# # load_filename = "simulate_20200209_222249_50_32768.npz"
# load_filename = "simulate_20200209_221406_100_32768.npz"
...
if Ntraj_g < Ntraj:
    print("*** WARNING: {:d} NaNs in scores_g!".format(Ntraj - Ntraj_g))
if Ntraj_e < Ntraj:
    print("*** WARNING: {:d} NaNs in scores_e!".format(Ntraj - Ntraj_e))
...
mu_avg = abs(mu_e - mu_g) / 2
sigma_avg = (sigma_e + sigma_g) / 2
...
n, bins, patches = ax1.hist(
    scores_g,
    bins=128,
    range=(-mu_avg - 4 * sigma_avg, mu_avg + 4 * sigma_avg),
    color='tab:blue',
    alpha=0.5,
    label='|g>',
)
...
#     thomoz = np.zeros(Nbins)
#     thomox = np.zeros(Nbins)
#     thomoy = np.zeros(Nbins)
...
#     ax2.plot(bins_ctr, thomoz, label=r"$\left< \sigma_\mathrm{Z} \right>$")
#     ax2.plot(bins_ctr, thomox, label=r"$\left< \sigma_\mathrm{X} \right>$")
#     ax2.plot(bins_ctr, thomoy, label=r"$\left< \sigma_\mathrm{Y} \right>$")

#     def myfunc(x, a):
#         return np.tanh(a * x)

#     idx = np.isfinite(thomoz)
#     popt, pcov = curve_fit(myfunc, bins_ctr[idx], thomoz[idx])
...
#         patch.set_color(cmap((thomoz[ii] + 1) / 2))
...
#             p0=(mu_avg, sigma_avg),
#         )
#         print("Im / s**2 from histrogram fit: {}".format(
#             popt2[0] / popt2[1]**2))
