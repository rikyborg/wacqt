...
ax31.axvline((_wc - _chi) / (2. * np.pi), ls='--', c='tab:gray')
ax31.axvline((_wc + _chi) / (2. * np.pi), ls='--', c='tab:gray')
ax31.semilogy(freqs, np.abs(para_g.tf2(freqs)), c='tab:blue')
ax31.semilogy(freqs, np.abs(para_e.tf2(freqs)), c='tab:orange')

ax32.axvline((_wc - _chi) / (2. * np.pi), ls='--', c='tab:gray')
ax32.axvline((_wc + _chi) / (2. * np.pi), ls='--', c='tab:gray')
ax32.plot(freqs, np.angle(para_g.tf2(freqs)), c='tab:blue')
ax32.plot(freqs, np.angle(para_e.tf2(freqs)), c='tab:orange')

ax31.set_title("Transmission")
